...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        # Añade otras clases de autenticación si las necesitas
    ),
    # Configura la paginación, permisos, etc. si usas otras características de DRF
}

# Configuración opcional de Simple JWT
# SIMPLE_JWT = {
